	...
	async run(bot, message) {
		...
		if (message.guild.icon) {
			const embed = new Embed(bot, message.guild)
				.setDescription(
					message.translate('guild/guildicon:ICON', {
			...
			message.channel
				.error('guild/guildicon:NO_GUILD_ICON')
	...
	async callback(bot, interaction, guild) {
		...
		if (guild.icon) {
			const embed = new Embed(bot, guild)
				.setDescription(
					guild.translate('guild/guildicon:ICON', {
			...
			interaction.reply({
				embeds: [channel.error('guild/guildicon:NO_GUILD_ICON', {}, true)],
				ephemeral: true,
			})
		}
	}
