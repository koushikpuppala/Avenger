...
class ReactionRoleRemove extends Command {
	...
	constructor(bot) {
		super(bot, {
			...
			usage: 'reactionroles-remove <messagelink>',
			cooldown: 5000,
			examples: [
				'reactionroles-remove https://discord.com/channels/750822670505082971/761619652009787392/837657228055937054',
			],
		})
	}
	...
	async run(bot, message, settings) {
		...
		// make sure an arg was sent as well
		if (!message.args[0])
			return message.channel
				.error('misc:INCORRECT_FORMAT', {
					EXAMPLE: settings.prefix.concat(message.translate('plugins/rr-remove:USAGE')),
				})
