...
const guildScheme = Schema({
	...
	welcomePrivateToggle: {
		type: Boolean,
		default: false,
	},
	welcomePrivateText: {
		type: String,
		default: 'Have a great time here in **{server}**.',
	},
	welcomeRoleToggle: {
		type: Boolean,
		default: false,
	...
	welcomeRoleGive: {
		type: Array,
		default: ['562297641879470082'],
	},
	welcomeGoodbyeToggle: {
		type: Boolean,
		default: false,
	},
	welcomeGoodbyeText: {
	...
	LevelMessage: {
		type: String,
		default: 'GG {user}, you have leveled up to {level}!',
	},
	LevelIgnoreRoles: {
		type: Array,
		default: ['No-xp'],
	...
	ModLogEvents: {
		type: Array,
		default: ['GUILDBANADD', 'GUILDMEMBERADD'],
	},
	ModLogChannel: {
		type: String,
		default: '00',
	...
	ModerationExternalLinksAllowed: {
		type: Array,
		default: ['https://www.google.com', 'https://www.youtube.com'],
	},
	...
	plugins: {
		type: Array,
		default: ['Animals', 'BotDevelopers', 'Fun', 'Games', 'Giveaway', 'Guild', 'Host', 'Image', 'Invites', 'Level', 'Misc', 'Moderation', 'Music', 'NSFW', 'Plugins', 'Reactions', 'Reminders', 'Recording', 'Searcher', 'Ticket', 'Utils'],
	},
	version: {
		type: Number,
		default: '1.0',
