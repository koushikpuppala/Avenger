 ...
 * @event Avenger#VoiceStateUpdate
 * @extends {Event}
 */
			...
			if (updated) {
				...
				try {
					const modChannel = await bot.channels
						...
						.catch(() =>
							bot.logger.error(
								`Error fetching guild: ${newState.guild.id} logging channel`
							)
						)
