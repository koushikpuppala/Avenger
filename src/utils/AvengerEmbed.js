 ...
 */
class AvengerEmbed extends MessageEmbed {
	/**
	...
	setTitle(key, args) {
		const language =
			...
			require('../assets/json/defaultGuildSettings.json').Language
		this.title = this.bot.translate(key, args, language)
			? this.bot.translate(key, args, language)
			: key
		return this
	}
