...
exports.log = (content, type = 'log') => {
	...
	case 'posted':
		log.info(content);
		console.log(`${timestamp} ${chalk.black.bgMagentaBright(type.toUpperCase())} ${content}`);
		break;
	case 'ping':
		log.info(content);
		console.log(`${timestamp} ${chalk.underline.cyan.bgWhite(type.toUpperCase())} ${content} `);
		break;
	default:
		break;
	}
...
exports.posted = (...args) => this.log(...args, 'posted');

exports.ping = (...args) => this.log(...args, 'ping');
